...
import { GripVertical, Eye, EyeOff, Plus, Save, RotateCcw, LayoutDashboard, FileText, Activity, Stethoscope, Pill, Image, FolderOpen, History, Heart, ClipboardList, Target, Paperclip, Smile, Crosshair, Camera } from 'lucide-react';
